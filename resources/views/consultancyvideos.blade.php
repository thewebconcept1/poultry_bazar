...
@section('content')
    <div class="w-full pt-10 min-h-[88vh] gradient-border  rounded-lg">
        <div class="flex justify-between px-5">
            ...
            <button data-modal-target="consultancy-modal" data-modal-toggle="consultancy-modal"
                ...
                <form id="postDataForm" method="POST" url="../saveMedia" enctype="multipart/form-data">
                    ...
                    <div class="grid gap-4 grid-cols-2 ">
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <x-input id="mediaAuthor" label="Consultancy Author" placeholder="Enter Consultancy Author"
    ...
    <script>
        function updateDatafun() {
            ...
            $('.updateDataBtn').click(function() {
                $('#consultancy-modal').removeClass("hidden");
                $('#consultancy-modal').addClass('flex');
        ...
        $('#addModalBtn').click(function() {
            ...
            $('#consultancy-modal #submitBtn').text("Add Consultancy");
