...
<body class="text-gray-800 bg-white">
    ...
    <div class="section" id="home">
        <div
            ...
            <div class="flex flex-col justify-center items-center h-[100%] w-[100%] relative z-40 max-w-[480px]">
                <div id="welcomeDiv" class="flex flex-col items-center justify-start">
                    <h2 class="text-[50px] text-customOrangeDark font-bold leading-none">
                        ...
                        <p class="flex justify-start text-justify  mt-4 font-light   text-[14px] text-gray-600 ">
        ...
        <div class="grid grid-cols-2 gap-5 px-6 py-4 xl:mt-0 md:mt-6 lg:grid-cols-5 sm:grid-cols-2 md:grid-cols-3 md:px-12">
            ...
            <div class="justify-center w-40 h-20 px-4 text-center ">
