...
<body class="text-gray-800 bg-white">
    ...
    <div class="section" id="home">
        <div
            ...
            <div class="flex flex-col justify-center items-center h-full w-full relative z-40 max-w-[480px]">
                <div id="welcomeDiv" class="flex flex-col items-center justify-start">
                    <h2 class="text-[50px] text-customOrangeDark font-bold leading-none">
                        ...
                        <p
                            class="flex justify-start text-justify  mt-4 font-light   text-[14px] text-gray-600 ">
            ...
            <div class="z-40 flex items-center justify-center w-screen min-h-screen gap-5 p-10 lg:p-0">
        ...
        <div
            class="grid  lg:grid-cols-5 grid-cols-1 sm:grid-cols-2 gap-5  md:grid-cols-3  md:gap-5   px-[100px] py-4">
            <div class="w-40 h-20 border rounded-lg border-customOrangeDark ">
            ...
            <div class="w-40 h-20 px-4 text-center ">
    ...
    <div class="flex items-center justify-center mt-12">
        <div class="text-center">
            ...
            <p class="mt-2 text-gray-500">Our delivery offers on-demand delivery and courier services for business and
                consumers</p>
        </div>
    </div>
        ...
        <div class="container px-4 mx-auto">
            <div class="grid grid-cols-1 gap-8 text-center md:grid-cols-3">
                ...
                <div class="flex flex-col items-center">
                    ...
                    <p class="mt-2 text-gray-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                ...
                <div
                   ...
                   <div class="px-6 py-8">
                    ...
                    <p class="mt-4 text-2xl font-bold">$10 <span class="text-sm font-normal">/mon</span></p>
                    ...
                    <button class="px-4 py-2 mt-8 font-semibold text-black bg-white border rounded-md">SIGN UP
                        NOW</button>
                   </div>
                    <!-- SVG Wave -->
                ...
                <!-- Repeat for Card 2 and Card 3 with the same SVG wave -->
                <!-- Card 2 -->
                <div
                    class="flex flex-col justify-between overflow-hidden text-center bg-white rounded-lg shadow-2xl ">
                   <div class="px-6 py-8">
                    ...
                    <p class="mt-2 text-gray-500">Fast start your business with this</p>
                    <p class="mt-4 text-2xl font-bold">$20 <span class="text-sm font-normal">/mon</span></p>
                    <ul class="mt-4 space-y-2 text-sm text-gray-600">
                        <div class="flex justify-between pt-2">
                            <div>
                                <li>Client Panel</li>
                    ...
                    <button class="px-4 py-2 mt-8 font-semibold text-white rounded-md bg-customOrangeDark">SIGN UP
                        NOW</button>
                   </div>
                    <!-- SVG Wave -->
                    <div class="bottom-0 left-0 w-full overflow-hidden ">
                ...
                <!-- Card 3 -->
                <div class="flex flex-col justify-between overflow-hidden text-center bg-white rounded-lg shadow-2xl ">
                    <div class="px-6 py-8">
                        <h3 class="text-lg font-semibold text-customOrangeDark">Advance</h3>
                        <p class="mt-2 text-gray-500">Fast start your business with this</p>
                        <p class="mt-4 text-2xl font-bold">$50 <span class="text-sm font-normal">/mon</span></p>
                        <ul class="mt-4 space-y-2 text-sm text-gray-600">
                            <div class="flex justify-between pt-2">
                                <div>
                                    <li>Client Panel</li>
        ...
        <footer class="mt-8 bg-white ">
            <div class="container grid gap-8 px-4 mx-auto text-center md:grid-cols-4 md:text-left">
                ...
                <div class="h-32 mt-20">
                    ...
                    <p class="text-gray-500">Best delivery services in Germany. Using by more than 3,000,000 people in the world</p>
                </div>
                ...
                <div class="flex flex-col items-center md:items-start">
                    <svg width="220" height="220" viewBox="0 0 220 220" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M93.3516 134.981C90.683 135.162 89.2846 133.03 89.323 130.952C89.3636 128.818 90.8943 126.896 93.3516 126.971C95.7342 127.037 97.3951 128.621 97.4079 131.006C97.4207 133.391 95.7769 134.972 93.3516 134.981Z" fill="url(#paint7_linear_1789_9187)"/>
                        ...
                        <path d="M132.952 66.8166C135.241 66.8059 137.009 68.5907 137.034 70.8985C137.026 71.9806 136.595 73.0166 135.833 73.7848C135.071 74.5529 134.038 74.9921 132.956 75.0082C130.92 75.0082 129.001 73.5138 128.939 70.9519C128.917 70.4135 129.006 69.8763 129.199 69.3731C129.391 68.8698 129.684 68.411 130.059 68.0243C130.435 67.6376 130.885 67.3312 131.382 67.1236C131.879 66.916 132.413 66.8115 132.952 66.8166Z" fill="url(#paint9_linear_1789_9187)"/>
                        </g>
                        <defs>
                        <filter id="filter0_d_1789_9187" x="28.4248" y="50.3047" width="164.42" height="118.074" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                        ...
                        <linearGradient id="paint0_linear_1789_9187" x1="100.822" y1="51.3047" x2="100.822" y2="118.608" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#FCB376"/>
                        <stop offset="1" stop-color="#FE8A29"/>
                        </linearGradient>
                        ...
                        <linearGradient id="paint2_linear_1789_9187" x1="77.1761" y1="141.543" x2="77.1761" y2="166.047" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#FCB376"/>
                        <stop offset="1" stop-color="#FE8A29"/>
                        </linearGradient>
                        ...
                        <linearGradient id="paint4_linear_1789_9187" x1="54.1203" y1="141.766" x2="54.1203" y2="165.656" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#FCB376"/>
                        <stop offset="1" stop-color="#FE8A29"/>
                        </linearGradient>
                        ...
                        <linearGradient id="paint7_linear_1789_9187" x1="93.3651" y1="126.969" x2="93.3651" y2="134.992" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#FCB376"/>
                        <stop offset="1" stop-color="#FE8A29"/>
                        </linearGradient>
                        ...
                        <linearGradient id="paint9_linear_1789_9187" x1="132.985" y1="66.8164" x2="132.985" y2="75.0082" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#FCB376"/>
                        <stop offset="1" stop-color="#FE8A29"/>
                        </linearGradient>
                        </defs>
