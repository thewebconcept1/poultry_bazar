    ...
    <div class="w-full pt-10 min-h-[88vh] gradient-border  rounded-lg">
        ...
        <x-table :headers="$headers">
            <x-slot name="tablebody">
                <tr>
                    ...
                    <td class='text-xs xl:text-[15px]'>Kurt Weissnat</td>
                    <td class='text-xs xl:text-[15px] '>Barrows - Rohan </td>
                    <td class='text-xs xl:text-[15px]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lorem ipsum
                        dolor sit amet...</td>
                    <td class='text-sm xl:text-[15px]'>Oct 02, 2024 </td>
                    <td class='text-sm xl:text-[15px]'><span class='text-[#007AFF]'>New</span></td>
        ...
        <x-modal id="view-modal">
            ...
            <x-slot name="body">
                <div class="p-6 pt-1">
                    <div class="flex">
                        <div><img class="object-contain w-36 h-36 " src="{{ asset('assets/Surface 3 rounded.png') }}"
                                alt=""></div>
                        <!-- Text Details -->
                        <div class="mt-8 ml-5">
                            <h3 class="text-xl font-semibold text-gray-800">User Name</h3>
                            <p class="mt-3">user@gmail.com</p>
                        </div>
                    </div>

                    <!-- Description -->
                    <div class="mt-4">
                        <h4 class="text-lg font-semibold text-gray-800">Subject: <span class="font-medium">Subject
                                Here</span></h4>
