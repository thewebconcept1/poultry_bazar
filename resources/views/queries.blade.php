    ...
    <div class="w-full pt-10 min-h-[88vh] gradient-border  rounded-lg">
        ...
        @php
            ...
            $body =
                ...
                <td class='text-xs xl:text-[15px]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lorem ipsum dolor sit amet...</td>
        ...
        <x-modal id="view-modal">
            ...
            <x-slot name="body">
                <div class="p-6 pt-1">
                    <div class="flex">
                        <div><img class="object-contain w-36 h-36 " src="{{ asset('assets/Surface 3 rounded.png') }}" alt=""></div>
                        <!-- Text Details -->
                        <div class="mt-8 ml-5">
                    ...
                    <!-- Description -->
                    <div class="mt-4">
                        <h4 class="text-lg font-semibold text-gray-800">Subject: <span class="font-medium">Subject Here</span></h4>
