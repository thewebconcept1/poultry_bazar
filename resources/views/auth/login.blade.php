...
@section('content')
    <div class="relative w-screen h-screen">
        ...
        <div id="mainContent" class="flex justify-between h-[80vh] pt-[10vh] mx-[50px] lg:mx-[100px] xl:mx-[180px] z-50 relative transition-all duration-700">
            <!-- Welcome Section -->
            <div id="welcomeDiv" class="flex flex-col justify-center items-center h-full w-full relative z-50 max-w-[600px] transition-all duration-700 ease-in-out">
                <div>
                ...
                <button id="switchToLoginBtn" class="gradient-bg w-[300px] text-white rounded-full text-lg font-semibold h-14 mt-40">
                    Get Access
                </button>
            </div>

            <!-- Login Form Section -->
            <div id="loginDiv" class="max-w-[600px] px-8 flex flex-col justify-center items-center h-full w-full rounded-2xl transition-all duration-700 ease-in-out"
                    ...
                    <form action="">
                        <div class="mt-20">
                            <div>
                                ...
                                <input type="email" id="email" class="w-full mt-1 bg-white border border-gray-400 rounded-2xl placeholder:text-customGrayColorDark placeholder:text-sm" placeholder="Enter your email">
                            </div>
                            <div class="mt-5">
                                <label for="password" class="block text-sm text-customGrayColorDark">Password</label>
                                <input type="password" id="password" class="w-full mt-1 bg-white border border-customGrayColorDark rounded-2xl placeholder:text-customGrayColorDark placeholder:text-sm" placeholder="Enter your password">
                            </div>
                            <div>
                                <p class="text-xs text-right text-customOrangeDark">Forgot password?</p>
                            </div>
                            <button type="submit" class="w-full mt-8 text-lg text-white rounded-full gradient-bg font-semi-bold h-14">Log in</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div id="signupSection" class="flex justify-between h-[80vh] pt-[10vh] mx-[50px] lg:mx-[100px] xl:mx-[180px] z-50 relative hidden">
                ...
                <div class="w-full">
                    ...
                    <form action="">
                        <div class="mt-20">
                            ...
                            <div>
                                <label for="" class="block mt-5 text-sm text-customGrayColorDark">Confirm Email</label>
                                <input type="text"
                                    class="w-full mt-1 bg-white border border-gray-400 rounded-2xl placeholder:text-customGrayColorDark placeholder:text-sm"
                            ...
                            <button class="w-full mt-8 text-lg text-white rounded-full gradient-bg font-semi-bold h-14">Next</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="flex flex-col justify-center items-center h-full w-full relative z-50 max-w-[600px]">
                <div>
                    ...
                    <button type="submit" class="w-full mt-8 text-lg text-white rounded-full gradient-bg font-semi-bold h-14">Get Access</button>
                </div>
    ...
    <script>
        ...
        switchToLogin.addEventListener('click', function () {
            // Reverse the div positions and show the login form
            signupSection.classList.add('hidden');
            mainContent.classList.remove('hidden');

            // Animate the image flip back to original
