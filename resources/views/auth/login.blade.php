                    ...
                    <div class="w-full">
                        ...
                        <form id="loginForm" action="">
                            ...
                            <div class="mt-20">
                                ...
                                <div>
                                    <a href="">
                                        <p class="mt-5 text-xs text-right text-customOrangeDark">Forgot password?</p>
                                    </a>
                                </div>
                ...
                <div class="p-5 w-5xl xl:px-5 xl:p-0">
                    ...
                    <div id="mainContent"
                        ...
                        <div id="loginDiv"
                            ...
                            <div class="w-full">
                                <div>
                                    <h1 class="text-customBlackColor font-bold text-[44px] text-center">Forgot Password
                                    </h1>
                                    <p class="mt-5 text-sm text-center text-customBlackColor">Enter your Email to
                                        receive password reset link.</p>
                                </div>
                                <form id="loginForm" action="">
                                    @csrf --}}
                    {{-- <form id="animatedForm" action=""> --}}
                   ...
                   <div>
                                        ...
                                        <div class="text-center">
                                            <a href="">
                                                <p class="mt-5 text-xs ">Remember your password?<span class="mt-5 text-xs text-customOrangeDark"> Login Here</span></p>
                                            </a>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <div id="signupSection"
                        ...
                        <div
                            class="flex flex-col justify-center items-center h-full w-full relative z-40 max-w-[480px]">
                        ...
                        <form id="registerForm" method="POST"
                            ...
                            <div id="signupForm" class="w-full h-full m-5 ">
                                ...
                                <div class="mt-10">
                                    ...
                                    <div class="mt-4">
                                        <label for="email"
                                            class="block text-sm text-customGrayColorDark">Email</label>
                                    ...
                                    <div class="mt-4">
                                        <label for="phone"
                                            class="block text-sm text-customGrayColorDark">Phone</label>
                                    ...
                                    @foreach ($modules as $module)
                                        <div class="relative">
                                            <input type="checkbox" name="module_id[]"
                                                value="{{ $module->module_id }}" id="market-{{ $module->module_id }}"
                                                class="sr-only peer">
                            ...
                            <div class="relative">
                                ...
                                <label for="market1"
                                    ...
                                    <button id="" data-modal-target="modal" data-modal-toggle="modal"
                                        type="button"
                        ...
                        <div class="flex flex-col items-center mt-3">
                            ...
                            <div class="relative px-10 mt-4 mb-5">
                                <p class="text-xl leading-relaxed text-justify text-gray-400">
                                    Stay informed with live updates on the latest poultry market rates. This feature
                                    provides
                                    users with
                                    real-time price trends for chickens across different regions. Gain insights to make
                                    informed
                                    decisions
