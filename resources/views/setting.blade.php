                        ...
                        <form>
                            <div class="flex items-center mb-3">
                                ...
                                <div class="flex-col w-3/4 ">
                                    ...
                                    <div class="w-1/2">
                                        <x-file-uploader name="user_image" id="profileImage" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center mb-4">
                                ...
                                <div class="w-3/4">
                                    <input name="fullName" type="text" class="w-full border-gray-300 rounded form-input"
                            ...
                            <div class="flex items-center mb-4">
                                ...
                                <div class="w-3/4">
                                    <input name="company" type="text" class="w-full border-gray-300 rounded form-input"
                            ...
                            <div class="flex items-start mb-4">
                                <label for="about" class="w-1/4 text-gray-700">Address</label>
                                <div class="w-3/4">
