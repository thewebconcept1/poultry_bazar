    ...
    <div class="flex justify-between px-5">
        <div class="flex gap-5">
            ...
            <div class="flex gap-4">
                <button id="blogBtn" class="px-3 py-2 font-semibold text-black  border-2 rounded-full shadow-md hover:border-1 border-[#FCB579] active-btn" onclick="showCategory('blog')">Blog Categories</button>
                <button id="diseaseBtn" class="px-3 py-2 font-semibold text-white rounded-full shadow-md gradient-bg" onclick="showCategory('disease')">Diseases Categories</button>
                <button id="consultancyBtn" class="px-3 py-2 font-semibold text-white rounded-full shadow-md gradient-bg" onclick="showCategory('consultancy')">Consultancy Categories</button>
            </div>
        </div>
