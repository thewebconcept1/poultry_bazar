    ...
    <div class="w-full pt-10 min-h-[88vh] gradient-border  rounded-lg">
        <div class="flex justify-between px-5">
            <div class="flex gap-5">
                ...
                <div>
                    <button class="px-3 py-2 font-semibold text-black border-black rounded-full shadow-md border-1 bg">Add New +</button>
                    <button class="px-3 py-2 font-semibold text-white rounded-full shadow-md gradient-bg">Add New +</button>
                    <button class="px-3 py-2 font-semibold text-white rounded-full shadow-md gradient-bg">Add New +</button>
                </div>
            </div>
